...
import { clearChat, fetchChats, listBots, loadMoreChats } from '@/redux/chat/actions'
...
export const chatSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addMatcher(isAnyOf(fetchChats.fulfilled, loadMoreChats.fulfilled), (state, action) => {
        if (!action.payload) return
